...
import { na_a, na_b, na_c, na_d, na_e, na_f, na_g, na_h, na_i, na_j, na_k, na_l, na_ll, na_m, na_n, na_o, na_p, na_r, na_s, na_t, na_u, na_w, na_y, na_z, na_z1, na_z2 } from ".";
...
export function dictionary(): Observable<string[]> {
  const words = 
    ...
    .concat(split_by_5(na_z1))
    .concat(split_by_5(na_z2))
